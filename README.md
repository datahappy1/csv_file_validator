...
- in `settings.conf` file 
    - you can set the variable `RESUME_ON_FOUND_VALIDATION_ERROR` to `True` or `False`, this variable drives the behavior whether the tool stops validations on a first found failed validation or not
